...
import { ShoppingCart, MapPin, Fuel, Clock, TrendingUp, Plus } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Link href="/dashboard/order/new" className="card p-6 flex items-center gap-4 hover:border-primary-300 transition-colors">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Order diesel for your delivery site</p>
          </div>
        </Link>
      ...
      <div className="card">
        ...
        {recentOrders.length === 0 ? (
          <div className="px-6 py-8 text-center text-gray-500">No orders yet. Place your first order above!</div>
        ) : (
