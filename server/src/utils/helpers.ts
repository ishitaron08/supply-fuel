...
import { ORDER_PREFIX, INVOICE_PREFIX, OTP_LENGTH } from 'shared';

export const generateAccessToken = (payload: { id: string; email: string; role: string; name: string }): string => {
